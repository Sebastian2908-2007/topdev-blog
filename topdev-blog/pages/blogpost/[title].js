...
export default function Post ({post}) {
  ...
  console.log(postObj.category);
    ...
    <div className="m-4 d-flex flex-row justify-content-between">
     ...
     <button onClick={() => {setOpenShareModal(true); setModalInfo({image:'/topdev-logo.png',title:`${postObj.title}`});}} className="border border-light bg-light p-2 rounded-circle">
